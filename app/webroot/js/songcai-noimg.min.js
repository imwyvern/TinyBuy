...
(function(a){a.normalizeNumber=function(a){10>a&&(a="0"+a);return a}})(sc);(function(a){a.togglePic=function(a){$(a).click(function(){setCookie("pic_status","yes",100);window.location.reload()})}})(sc);(function(a){a.getWechatId=function(){for(var a=document.cookie.split("; "),b=0;b<a.length;b++){var c=a[b].split("=");if("wechat_id"==c[0])return unescape(c[1])}}})(sc);
$(function(){app.menuView=new app.MenuView;app.menuView.setPic(!1);app.shoppingCart=new app.Order;app.vegetableCollection=new app.ItemCollection;app.meatCollection=new app.ItemCollection;app.soupCollection=new app.ItemCollection;app.specialityCollection=new app.ItemCollection;app.shoppingCartV=new app.ShoppingCartView({model:app.shoppingCart});$("#menu-container").append(app.shoppingCartV.render().el);$(".loader-mask").remove();app.menuView.renderList(1);$("#menu-shadow").bind("click",function(){$("#menu-dropdown").hide();
$("#menu-shadow").hide()});$("#todayList").bind("click",function(){window.location.reload()});$("#myOrder").bind("click",function(){$(".container").css("display","none");if("CUSTOMER"==user_status&&!sc.getWechatId()){$("#menu-shadow").click();$(".container").hide();var a=new app.LoginView({backTo:"menu-container"});$(".main-container").append(a.render().el)}else 0<$("#myOrders-container").length?$("#myOrders-container").show():app.myOrderView=new app.MyOrdersView;$("#menu-shadow").click()});$("#logout").click(function(){if("CUSTOMER"==
user_status&&!sc.getWechatId()){$("#menu-shadow").click();$(".container").hide();var a=new app.LoginView({backTo:"menu-container"});$(".main-container").append(a.render().el)}else setCookie("wechat_id","",-1),a=new app.OrderInfoPopupView({msg:"\u9000\u51fa\u767b\u5f55\u6210\u529f\uff01"}),$("#menu-dropdown").append(a.render().el),setTimeout(function(){$("#menu-shadow").click();$(".container").hide();var a=new app.LoginView({backTo:"menu-container"});$(".main-container").append(a.render().el)},2E3)});
$("#home-header").bind("touchmove",{},function(a){a.preventDefault()});$(".toolbar").bind("touchmove",{},function(a){a.preventDefault()});$(window).scrollTop(2)});